...
export class First1686400458100 implements MigrationInterface {
    name = 'First1686400458100'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bill" ("id" SERIAL NOT NULL, "user_id" integer NOT NULL, "account_id" integer NOT NULL, "currency_id" integer NOT NULL, "type" integer NOT NULL, "status" integer NOT NULL, "date" TIMESTAMP NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_683b47912b8b30fe71d1fa22199" PRIMARY KEY ("id"))`);
